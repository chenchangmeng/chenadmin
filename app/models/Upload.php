...
class Upload {
	...
	// Process the file
		...
		*/
		...
		$this->HandleError(HTML::image("upload/{$fileDir}/".$file_name, '', array('height'=>80,'width'=>180, 'id'=>$typeImg.'DivImg')),HTML::imageUrl("upload/{$fileDir}/".$file_name), $typeImg);
		exit(0);
	...
	public function HandleError($message, $imgUrl='',$typeImg = "promoteUrl") {
		$info = array(
			'message' => $message,
			'imgurl' => $imgUrl,
			'typeImg' => $typeImg
