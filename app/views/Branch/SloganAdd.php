...
<div class="container">
	...
	<div class="row clearfix" style="margin-top:10px;">
		...
		<div class="col-md-10 column">	
			...
			<?php echo Form::open(array('url' => 'branch/slogan-add-data', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'slogan_add_form'));  ?>
				...
				<div class="form-group">
					...
					<input type="hidden"  name="sloganUrl" id="sloganUrl" value="">
				...
				<div class="form-group">
					...
					<div class="col-xs-7" id="position_mess">
						<input type="text" class="form-control operate-form" maxlength="50" name="position" id="position" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-7" id="company_mess">
						<input type="text" class="form-control operate-form" maxlength="50" name="company" id="company" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-7" id="slogan_mess">
						<textarea name="slogan" id="slogan" class="form-control operate-form"></textarea>
					</div>
				</div>
