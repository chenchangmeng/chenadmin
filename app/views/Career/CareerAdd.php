...
<div class="container">
	...
	<div class="row clearfix" style="margin-top:10px;">
		...
		<div class="col-md-10 column">	
			...
			<?php echo Form::open(array('url' => 'career/career-add-data', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'career_add_form'));  ?>
				<div class="form-group">
					...
					<div class="col-xs-7" id="careerName_mess">
						<input type="text" class="form-control operate-form" maxlength="80" name="careerName" id="careerName" />
					</div>
				</div>
				<div class="form-group">
