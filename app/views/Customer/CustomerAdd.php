...
<div class="container">
	...
	<div class="row clearfix" style="margin-top:10px;">
		...
		<div class="col-md-10 column">	
			...
			<?php echo Form::open(array('url' => 'customer/customer-add-data', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'customer_add_form'));  ?>
				...
				<div class="form-group">
					...
					<div class="col-xs-7" id="name_mess">
						<input type="text" class="form-control operate-form" maxlength="50" name="name" id="name" />
					</div>
				</div>

				<div class="form-group">
					<label for="real_name" class="col-sm-2 control-label"></label>
					<input type="hidden"  name="customerUrl" id="customerUrl" value="">
				...
				<div class="form-group">
					...
					<div class="col-xs-7" id="url_mess">
						<input type="text" class="form-control operate-form" maxlength="150" name="url" id="url" />
					</div>
				</div>
