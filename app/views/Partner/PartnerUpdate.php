...
<div class="container">
	...
	<div class="row clearfix" style="margin-top:10px;">
		...
		<div class="col-md-10 column">	
			...
			<?php echo Form::open(array('url' => 'partner/partner-update-data', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'partner_update_form'));  ?>
			<input type="hidden" name="id" id="id" value="<?php echo $resultData[0]->id; ?>" />
				<div class="form-group">
					...
					<div class="col-xs-7" id="brandName_mess">
						<input value="<?php echo $resultData[0]->brandName; ?>" type="text" class="form-control operate-form" maxlength="32" name="brandName" id="brandName" />
					</div>
				</div>

				<div class="form-group">
					<label for="real_name" class="col-sm-2 control-label"></label>
					<input type="hidden"  name="partnerUrl" id="partnerUrl" value="<?php echo $resultData[0]->logoImgUrl; ?>">
							...
							<div  class="col-md-10 column">
								<div class="fieldset partner" id="fsUploadProgress">
									<span class="legend">Partner Logo</span>
												...
												<div class="progressWrapper" id="partnerUrlID" style="opacity: 1;"><div class="progressContainer blue"><a class="progressCancel" href="#" style="visibility: hidden;"> </a><div></div><div class="progressBarStatus"><img id="partnerUrlDivImg" src="<?php echo $resultData[0]->logoImgUrl; ?>" height="80" width="180" alt=""></div><div class="progressBarComplete"></div></div></div>
