...
<div class="container">
	...
	<div class="row clearfix" style="margin-top:10px;">
		...
		<div class="col-md-10 column">	
			...
			<?php echo Form::open(array('url' => 'product/product-info-update-data', 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'product_update_form'));  ?>
				<input type="hidden" name="id" id="id" value="<?php echo $productInfo->id; ?>" />
				<input type="hidden" name="tid" id="tid" value="<?php echo $productInfo->tid; ?>" />
				...
				<div class="form-group">
					...
					<div class="col-xs-7" id="infoName_mess">
						<input type="text" class="form-control operate-form" maxlength="80" name="infoName" id="infoName" value="<?php echo $productInfo->infoName; ?>" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-7" id="sort_mess">
						<input type="text" class="form-control operate-form" maxlength="3" name="sort" id="sort" value="<?php echo $productInfo->sort; ?>" >
					</div>
				</div>
				<div class="form-group">
